...
class InvalidConfig extends Exception
{
    ...
    public static function invalidHandlesResponse(string $invalidHandlesResponseLimit): InvalidConfig
    {
        ...
        return new self("`{$invalidHandlesResponseLimit}` is not a valid handle response class. A valid handle response is a class that implements `{$handlesResponseLimitInterface}`.");
    }
    ...
    public static function invalidStreamedResponseHandler(string $invalidStreamedResponseHandler): InvalidConfig
    {
        ...
        return new self("`{$invalidStreamedResponseHandler}` is not a valid streamed response class. A valid streamed response is a class that implements `{$handlesStreamedResponseInterface}`.");
    }
}
